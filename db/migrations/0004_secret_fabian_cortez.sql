...
ALTER TABLE "players" DROP CONSTRAINT "players_discipline_id_tags_id_fk";
--> statement-breakpoint
ALTER TABLE "projects" DROP CONSTRAINT "projects_discipline_id_tags_id_fk";
--> statement-breakpoint
ALTER TABLE "teams" DROP CONSTRAINT "teams_discipline_id_tags_id_fk";
--> statement-breakpoint
